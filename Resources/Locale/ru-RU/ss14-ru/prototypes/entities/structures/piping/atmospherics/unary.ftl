...
ent-HeatExchangerInline = Проточный радиатор
    .desc = Переносит тепло между трубой и окружающей средой. Не требует потока газа
ent-HeatExchangerInlineBend = Проточный радиатор
    .desc = Переносит тепло между трубой и окружающей средой. Не требует потока газа
